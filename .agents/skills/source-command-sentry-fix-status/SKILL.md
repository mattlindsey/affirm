---
name: "source-command-sentry-fix-status"
description: "List all active Sentry fix branches and their status"
---

# source-command-sentry-fix-status

Use this skill when the user asks to run the migrated source command `sentry-fix-status`.
