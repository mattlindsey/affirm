...
RSpec.describe "CheckinsChart", type: :request do
  before do
    ...
    create(:mood_check_in, mood_level: 5, created_at: Time.zone.now.beginning_of_month + 1.day)
    create(:mood_check_in, mood_level: 8, created_at: Time.zone.now.beginning_of_month + 25.days)
    same_day = Time.zone.now.beginning_of_month + 9.days
    create(:mood_check_in, mood_level: 3, created_at: same_day + 2.hours)
    create(:mood_check_in, mood_level: 9, created_at: same_day + 5.hours)
  end
